...
import NodePanel from '@/components/LFComponents/NodePanel'//引入节点面板
...
import { nodeList } from '@/components/config.js'//引入节点配置
...
const demoData = require('@/components/data.json')

export default {
  name: 'LF',
  components: { NodePanel, AddPanel, PropertyDialog, DataDialog },
  data() {
    return {
      lf: null,
      showAddPanel: false,
